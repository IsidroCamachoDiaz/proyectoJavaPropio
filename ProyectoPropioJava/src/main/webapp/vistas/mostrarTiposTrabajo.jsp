...
try {
    ...
    if (accesoSesion.equals("1")) {
    	...
    	Escritura.EscribirFichero("Un usuario intento entrar a mostar tipos de trabajo");
...
Escritura.EscribirFichero("Se accedio al mostar tipos de trabajo");
...
var tipo = '<%= session.getAttribute("tipoAlerta") %>';
	...
	List <TipoTrabajoDTO> trabajos=acciones.SeleccionarTodosTiposDeTrabajo();
	
	List <TipoTrabajoDTO> trabajosActivos=new ArrayList <TipoTrabajoDTO> ();
	List <TipoTrabajoDTO> trabajosFinalizados=new ArrayList <TipoTrabajoDTO> ();
	
	for(TipoTrabajoDTO t:trabajos){
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 table-container">
            <table id="tabla1" class="table">
                ...
                <tbody>
                    <% for(TipoTrabajoDTO t:trabajosActivos){ 
                    %>
                        <tr>
            ...
            <table id="tabla2" class="table" style="display: none;">
                <caption class="text-center text-light">Tipos De Trabajo Finalizados</caption>
                <thead>
                    <tr>
                        <th>Descripcion</th>
                        <th>Precio Del Servicio</th>
                ...
                <tbody>
                    <% for(TipoTrabajoDTO t:trabajosFinalizados){ 
                    	SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
                        String fechaFormateada = sdf.format(t.getFecha_fin().getTime());
                    %>
                        <tr>
                            <td class="text-center"><%=t.getDescripcion_tipo() %></td>
                            <td class="text-center"><%=t.getPrecio_tipo() %></td>
